...
javac -d build src/*.java 
 ...
 steps { 
 sh ''' 
 echo "Running JUnit tests for File-Encrypter..." cd "Password Protection" 
pipeline { 
 agent any 
 stages { 
 stage('Build') { 
...
curl -L -o junit-platform-console-standalone.jar \ 
 https://repo1.maven.org/maven2/org/junit/platform/junit-platform console-standalone/1.10.0/junit-platform-console-standalone-1.10.0.jar  fi 
...
java -jar junit-platform-console-standalone.jar \ 
 ...
 steps { 
 sh ''' 
 echo "Deploying (Packaging) File-Encrypter Application..." cd "Password Protection" 
